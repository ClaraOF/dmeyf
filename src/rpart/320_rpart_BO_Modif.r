...
{
  #genero el modelo
  modelo  <- rpart("clase_ternaria ~ . -internet -tpaquete1 -mcaja_ahorro_dolares -mcajeros_propios_descuentos -mtarjeta_visa_descuentos -ctarjeta_master_descuentos -cmobile_app_trx -Master_madelantodolares", 
