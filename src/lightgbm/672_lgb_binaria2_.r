...
#ejecuto con archivos post feature engenering al estilo Franco
#karch_generacion  <- "./datasets/paquete_premium_202009_most_important_features_ratio.csv"
#karch_aplicacion  <- "./datasets/paquete_premium_202011_most_important_features_ratio.csv"

karch_generacion  <- "./datasets/paquete_premium_202009_most_important_features_ratio_clean.csv"
karch_aplicacion  <- "./datasets/paquete_premium_202011_most_important_features_ratio_clean.csv"
kBO_iter    <-  70 #150   #cantidad de iteraciones de la Optimizacion Bayesiana
